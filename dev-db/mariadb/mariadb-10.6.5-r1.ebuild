...
IUSE="+backup bindist cmake columnstore cracklib debug extraengine galera innodb-lz4
...
src_prepare() {
	...
	# if cmake is used, apply cmake patch
	if use cmake
	then
		eapply "${FILESDIR}"/mariadb-10.6.5-export-cmake-targets.patch
	fi
