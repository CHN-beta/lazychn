...
src_prepare() {
	...
	ewarn "This package is slightly modified from gentoo official to support cross-compiling."
	ewarn "It may be no compatible with bindist, as I used EROOT in src_* functions."
}
