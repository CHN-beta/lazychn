...
# This ebuild is pick from gentoo official with version bump and is not well tested
...
SRC_URI="https://github.com/lammps/lammps/archive/refs/tags/patch_17Feb2022.tar.gz -> ${P}.tar.gz"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64"
IUSE="cuda examples gzip kokkos lammps-memalign mpi netcdf python"
...
S="${WORKDIR}/lammps-patch_17Feb2022/cmake"
